...
class WordleGame:
    ...
    @classmethod
    def create_random_game(cls, host: User, guild_name: str, channel: str):
        word = cls.generate_random_word()
        return cls(host, guild_name, channel, word)

    @classmethod
    def create_random_length_word(cls, host: User, guild_name: str, channel: str):
        word = cls.generate_random_word()
    ...
    def process_guess(self, guess: str):
        ...
        for letter in guess:
            out_string += f":regional_indicator_{letter.lower()}: "
        out_string += "\n"
